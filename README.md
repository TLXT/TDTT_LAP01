...
* **Lý do lựa chọn:** Đây là một mô hình được tối ưu cực kỳ tốt, dung lượng nhẹ. Nó cho phép suy luận (inference) mượt mà và ổn định trên phần cứng CPU cá nhân nhưng vẫn đảm bảo độ chính xác cao trong việc nhận diện và mô tả chi tiết hình ảnh.

---

## ⚙️ 3. Mô tả chức năng hệ thống
